...
public class BoardController {
    ...
    public String getListByCategory(@PathVariable int categoryId,
                                    HttpSession session, Model model) {
    ...
    public String writeArticle(Board board, BindingResult results,
    ...
    public String replyArticle(Board board, RedirectAttributes redirectAttrs,
                               HttpSession session) {
    ...
    public String deleteArticle(Board board, HttpSession session,
